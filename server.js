...
const app=express();
const connecrDB=require('./config/connecrDB')


//app.listen(4000,()=>console.log("serveur est en  très  marche"))
const port=4000
//routes
...
connecrDB()
app.listen(port,(err)=>{
    err?console.log("error"):console.log('server is runing in port 4000')
})
